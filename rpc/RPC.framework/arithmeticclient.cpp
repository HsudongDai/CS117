...
main(int argc, char *argv[]) {
     ...
     try {
       ...
       //
       printf("Calling add(100, 200)\n");
       int x = add(100, 200);                          // remote call (we hope!)
       printf("Got %d\n", x);
       printf("Calling subtract(256, 128)\n");
       x = subtract(256, 128);                         // remote call (we hope!)
       printf("Got %d\n", x);
       printf("Calling multiply(20, 20)\n");
       x = multiply(20, 20);                           // remote call (we hope!)
       printf("Got %d\n", x);
       printf("Calling divide(100, 5)\n");
       x = divide(100, 5);                             // remote call (we hope!)
       printf("Got %d\n", x); 
